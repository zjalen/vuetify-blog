const routes = [
    ...
    {name: 'cate', path: '/cate/:cate/page/:page', component: () => import('../views/Articles')},
    {name: 'topic', path: '/topic/:topic/page/:page', component: () => import('../views/Articles')},
    {name: 'tag', path: '/tag/:tag/page/:page', component: () => import('../views/Articles')},
